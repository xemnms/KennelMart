...
public class ProductListingRequest {
    ...
    // Optional image URLs (for simplicity, accept list of URLs)
    ...
    public ProductListingRequest(String title, String description, BigDecimal price,
                                 Integer stockQuantity, ListingCategory category, List<String> imageUrls) {
        this.title = title;
